...
public class oldPeopleCountJob
{
    public static void main(String [] args)
    {
        try
        {
            ...
            Job job = Job.getInstance(conf, "old People Count");

            // Current Job
            job.setJarByClass(oldPeopleCountJob.class);

            // Set the Mapper class
            job.setMapperClass(oldPeopleCountMapper.class);

            // Set the reducer class
            job.setReducerClass(oldPeopleCountReducer.class);
