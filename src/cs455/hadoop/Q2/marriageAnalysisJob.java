...
public class marriageAnalysisJob {
    public static void main(String[] args) {
        try {
            ...
            // Current Job
            job.setJarByClass(marriageAnalysisJob.class);

            // Set the Mapper class
            job.setMapperClass(marriageAnalysisMapper.class);

            // Set the reducer class
            job.setReducerClass(marriageAnalysisReducer.class);
